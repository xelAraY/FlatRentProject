...
export const Home = () => {
  ...
  const rentalObjectsGroupData: IRentalObjectsGroupData[] = [
    ...
    { path: `api/home/get-by-total-area?field=TotalArea&minArea=40&maxArea=70`, title: "Просторные жилые решения: Квартиры от 50м² и более!", subTitle: "Выбирайте простор и уют в каждом уголке! Покорите новые горизонты комфорта!" },
