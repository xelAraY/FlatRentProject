  ...
  return (
    <Stack alignItems="center" justifyContent="center" style={{backgroundColor: "#F6F5F5", height: "100vh"}}>
      <Paper elevation={12} sx={{padding: '1.5rem', height: 'auto', borderRadius: '0.375rem', display:'flex', flexDirection: 'column', alignItems: 'center'}} >
          ...
          <Typography variant='h4' textAlign='center' mt={2}>Регистрация</Typography>
          <Stack flexDirection="column" height="auto" width="270px">
            ...
            <TextField 
              ...
              required
              helperText={errors?.phoneNumberMiss ? 'Номер телефона обязателен' : ''}
            ...
            <TextField 
              ...
              style={{marginTop:"15px"}}
              />
            <Button variant="contained" size="large" style={{marginTop: "15px", background: 'linear-gradient(to right, #ff9a2e, #a00cfe)'}} onClick={handleSubmit}>Зарегистрироваться</Button>
